...
public class BlockLogicRedstoneEmitter extends BlockLogicNetworkDevice {
    ...
    public boolean getDirectSignal(World worldSource, int x, int y, int z, Side side) {
        TileEntityRedstoneEmitter tile = (TileEntityRedstoneEmitter) worldSource.getTileEntity(x, y, z);
        return tile != null && tile.isActive;
    }

    @Override
    public boolean getSignal(WorldSource world, int x, int y, int z, Side side) {
        TileEntityRedstoneEmitter tile = (TileEntityRedstoneEmitter) world.getTileEntity(x, y, z);
        return tile != null && tile.isActive;
    }

    public void onBlockRemoved(World world, int x, int y, int z, int data) {
        TileEntityRedstoneEmitter tileEntityImporter = (TileEntityRedstoneEmitter) world.getTileEntity(x, y, z);
        label0:
