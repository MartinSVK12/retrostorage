...
import sunsetsatellite.retrostorage.containers.ContainerFluidStorageBus;
...
public class GuiFluidStorageBus extends GuiContainer implements IExtendedScreenDraw {

    public final TileEntityFluidStorageBus tile;
    ...
    public GuiFluidStorageBus(InventoryPlayer inventoryplayer, TileEntityFluidStorageBus tile) {
        super(new ContainerFluidStorageBus(inventoryplayer, tile));
        ySize = 220;
        this.tile = tile;
    ...
    protected void drawGuiContainerForegroundLayer() {
        fontRenderer.drawString("Fluid Storage Bus", 45, 6, 0x404040);
        ...
        if(tile.network != null) {
            ...
            if (controller != null) {
                ...
                fontRenderer.drawCenteredString(NumberUtil.format(tile.getFluidStackAmount()) + "/" + NumberUtil.format(tile.getMaxFluidStackSize()), 90, 112, color);
