            ...
            if (parent.calculationResult.getType() == CalculationResultType.RECURSIVE) {
                ...
                switch (pair.getRight()) {
                    case "missing":
                        ...
                        break;
                    case "missingFluids":
                        this.parent.drawString(this.parent.fontRenderer, "Missing: " + stack.stackSize + "mB" + " | Available: " + availableAmountFluids + "mB", j + 2, k + 12, 0xFF8080);
                        break;
                    case "toCraft":
                        ...
                        break;
                    case "toCraftFluids":
                        this.parent.drawString(this.parent.fontRenderer, "Will craft: " + stack.stackSize + "mB" + " | Available: " + availableAmountFluids + "mB", j + 2, k + 12, 0x8080FF);
                        break;
                    case "toProcess":
                    ...
                    case "toProcessFluids":
                        this.parent.drawString(this.parent.fontRenderer, "Will process: " + stack.stackSize + "mB" + " | Available: " + availableAmountFluids + "mB", j + 2, k + 12, 0x40CCFF);
                        break;
                    case "toTake":
                        this.parent.drawString(this.parent.fontRenderer, "Will use: " + stack.stackSize + "x | Available: " + availableAmount + "x", j + 2, k + 12, 0x80FF80);
                        break;
                    case "toTakeFluids":
                        this.parent.drawString(this.parent.fontRenderer, "Will use: " + stack.stackSize + "mB | Available: " + availableAmountFluids + "mB", j + 2, k + 12, 0x80FF80);
                        break;
                }
            }
        }
