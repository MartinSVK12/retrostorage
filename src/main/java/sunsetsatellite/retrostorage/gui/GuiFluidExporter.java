...
public class GuiFluidExporter extends GuiFluidFake
{

    public GuiFluidExporter(InventoryPlayer inventoryplayer, TileEntityFluidExporter tileEntityExporter)
    {
        super(new ContainerFluidExporter(inventoryplayer, tileEntityExporter),inventoryplayer);
    ...
    {
        fontRenderer.drawString("Fluid Exporter", 56, 6, 0x404040);
