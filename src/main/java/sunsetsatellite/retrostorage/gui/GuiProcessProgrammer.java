...
public class GuiProcessProgrammer extends GuiFluidFake {
    ...
    public void init() {
        ...
        controlList.add(new GuiButton(1, Math.round((float) width / 2 + 31), Math.round((float) height / 2 - 12), 40, 20, "Clear"));
        ...
        controlList.add(new GuiButton(8, Math.round((float) width / 2 - 27), Math.round((float) height / 2 - 12 + 20), 18, 4, ""));
        controlList.add(new GuiButton(9, Math.round((float) width / 2 - 8), Math.round((float) height / 2 - 12 + 20), 18, 4, ""));
    ...
    protected void buttonPressed(GuiButton guibutton) {
        ...
        switch (guibutton.id) {
            ...
            case 8:
                ...
                controlList.get(9).enabled = true;
                break;
            case 9:
                selected = "fluid";
                guibutton.enabled = false;
                controlList.get(8).enabled = true;
                break;
        }
