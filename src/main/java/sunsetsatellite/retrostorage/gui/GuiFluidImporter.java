...
public class GuiFluidImporter extends GuiFluidFake
{

    public GuiFluidImporter(InventoryPlayer inventoryplayer, TileEntityFluidImporter tileEntityImporter)
    {
        super(new ContainerFluidImporter(inventoryplayer, tileEntityImporter),inventoryplayer);
    ...
    {
        fontRenderer.drawString("Fluid Importer", 56, 6, 0x404040);
