...
import sunsetsatellite.retrostorage.screen.handler.FluidRedstoneEmitterScreenHandler;
import sunsetsatellite.retrostorage.util.DigitalItemRenderer;

import static sunsetsatellite.retrostorage.RetroStorage.gui;

public class FluidRedstoneEmitterScreen extends FilterScreen {
    private final FluidRedstoneEmitterBlockEntity tile;
    private final DigitalItemRenderer digitalItemRenderer = new DigitalItemRenderer(16, 16, HandledScreen.itemRenderer);

    public FluidRedstoneEmitterScreen(PlayerInventory playerInv, FluidRedstoneEmitterBlockEntity tile) {
        super(new FluidRedstoneEmitterScreenHandler(playerInv, tile));
        this.tile = tile;
    }
    ...
    protected void drawForeground() {
        textRenderer.draw(TranslationStorage.getInstance().getClientTranslation(tile.getName()), 38, 6, 0x404040);
