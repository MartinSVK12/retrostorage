...
public class StorageBusScreen extends ReSScreen implements IExtendedScreenDraw {

    public final StorageBusBlockEntity tile;
    ...
    public StorageBusScreen(PlayerInventory inventoryplayer, StorageBusBlockEntity tile) {
        super(new StorageBusScreenHandler(inventoryplayer, tile));
    ...
    protected void drawForeground() {
        textRenderer.draw("Storage Bus", 56, 6, 0x404040);
        ...
        if(tile.network != null) {
            ...
            if (controller != null) {
                ...
                drawCenteredString(tile.getStackAmount() + "/" + tile.getStackCapacity(), 90, 112, color);
            }
        }
