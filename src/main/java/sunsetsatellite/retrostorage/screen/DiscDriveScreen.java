...
public class DiscDriveScreen extends HandledScreen {
    ...
    public DiscDriveScreen(PlayerInventory playerInv, DiscDriveBlockEntity tile) {
        super(new DiscDriveScreenHandler(playerInv, tile));
        this.tile = tile;
    }
