...
public class FluidStorageBusScreen extends HandledScreen implements ExtendedScreenDraw {
    private final PlayerInventory playerInv;
    private final FluidStorageBusBlockEntity tile;
    ...
    public FluidStorageBusScreen(PlayerInventory playerInv, FluidStorageBusBlockEntity tile) {
        super(new FluidStorageBusScreenHandler(playerInv, tile));
    ...
    protected void drawForeground() {
        ...
        if (controller != null) {
            ...
            drawCenteredTextWithShadow(textRenderer, tile.getFluidStackAmount() + "/" + tile.getMaxFluidStackSize(), 90, 112, color);
        }
