...
public class FluidDiscDriveScreenHandler extends ScreenHandler {

    public FluidDiscDriveBlockEntity tile;

    public FluidDiscDriveScreenHandler(PlayerInventory playerInv, FluidDiscDriveBlockEntity tile) {
        this.tile = tile;
