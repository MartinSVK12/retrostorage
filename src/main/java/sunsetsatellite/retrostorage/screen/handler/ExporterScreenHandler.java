...
public class ExporterScreenHandler extends FilterScreenHandler {

    public ExporterBlockEntity tile;

    public ExporterScreenHandler(PlayerInventory playerInv, ExporterBlockEntity tile) {
        this.tile = tile;
