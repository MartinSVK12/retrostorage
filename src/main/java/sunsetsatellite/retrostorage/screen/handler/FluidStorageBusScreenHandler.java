...
public class FluidStorageBusScreenHandler extends ScreenHandler {

    public FluidStorageBusScreenHandler(Inventory iinventory, FluidStorageBusBlockEntity tile) {
        this.tile = tile;
