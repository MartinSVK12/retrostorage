...
public class FluidExporterScreenHandler extends FilterScreenHandler {

    public FluidExporterBlockEntity tile;

    public FluidExporterScreenHandler(PlayerInventory playerInv, FluidExporterBlockEntity tile) {
        this.tile = tile;
