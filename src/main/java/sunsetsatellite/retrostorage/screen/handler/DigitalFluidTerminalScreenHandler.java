...
public class DigitalFluidTerminalScreenHandler extends ScreenHandler {

    public DigitalFluidTerminalScreenHandler(Inventory iinventory, DigitalFluidTerminalBlockEntity tile) {
        this.tile = tile;
    ...
    private final DigitalFluidTerminalBlockEntity tile;
}
