...
public class FluidExporterScreen extends FilterScreen {
    private final FluidExporterBlockEntity tile;

    public FluidExporterScreen(PlayerInventory playerInv, FluidExporterBlockEntity tile) {
        super(new FluidExporterScreenHandler(playerInv, tile));
        this.tile = tile;
    }
