...
import sunsetsatellite.retrostorage.screen.handler.FluidExporterScreenHandler;

public class FluidExporterScreen extends FluidFakeScreen {

    public FluidExporterScreen(PlayerInventory inventoryplayer, FluidExporterBlockEntity tileEntityExporter) {
        super(new FluidExporterScreenHandler(inventoryplayer, tileEntityExporter));
    ...
    protected void drawForeground() {
        textRenderer.draw("Fluid Exporter", 56, 6, 0x404040);
    ...
    public FluidExporterBlockEntity tile;
}
