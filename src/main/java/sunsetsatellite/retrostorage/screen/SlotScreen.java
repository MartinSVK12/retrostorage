...
public abstract class SlotScreen {
    ...
    public SlotScreen(Minecraft minecraft, int i, int j, int k, int l, int i1) {
    ...
    public void buttonClicked(ButtonWidget guibutton) {
        if (guibutton.active) {
    ...
    public void render(int i, int j, float f) {
        ...
        GL11.glBindTexture(3553, 0);//this.minecraft.textureManager.getTextureId("/gui/background.png"));
        ...
        for (slotId = 0; slotId < amountSlots; ++slotId) {
            ...
            if (this.field_25123_p) {
                ...
                tessellator.color(0);
                tessellator.vertex(xBegin + 1, yBegin + yEnd + 1, 0.0, 0.0, 1.0);
                tessellator.vertex(xEnd - 1, yBegin + yEnd + 1, 0.0, 1.0, 1.0);
                tessellator.vertex(xEnd - 1, yBegin - 1, 0.0, 1.0, 0.0);
                tessellator.vertex(xBegin + 1, yBegin - 1, 0.0, 0.0, 0.0);
                tessellator.draw();
                GL11.glEnable(3553);
            }
        ...
        if (yBegin > 0) {
            ...
            tessellator.vertex(l, this.bottom, 0.0, 0.0, 1.0);
            tessellator.vertex(i1, this.bottom, 0.0, 1.0, 1.0);
            tessellator.vertex(i1, this.top, 0.0, 1.0, 0.0);
            tessellator.vertex(l, this.top, 0.0, 0.0, 0.0);
            tessellator.draw();
            tessellator.startQuads();
            tessellator.color(8421504, 255);
            tessellator.vertex(l, xBegin + yEnd, 0.0, 0.0, 1.0);
            tessellator.vertex(i1, xBegin + yEnd, 0.0, 1.0, 1.0);
            tessellator.vertex(i1, xBegin, 0.0, 1.0, 0.0);
            tessellator.vertex(l, xBegin, 0.0, 0.0, 0.0);
            tessellator.draw();
            tessellator.startQuads();
            tessellator.color(12632256, 255);
            tessellator.vertex(l, xBegin + yEnd - 1, 0.0, 0.0, 1.0);
            tessellator.vertex(i1 - 1, xBegin + yEnd - 1, 0.0, 1.0, 1.0);
            tessellator.vertex(i1 - 1, xBegin, 0.0, 1.0, 0.0);
            tessellator.vertex(l, xBegin, 0.0, 0.0, 0.0);
            tessellator.draw();
        }
