...
public interface IItemStackList {
     ...
     */
    @UnmodifiableView
    List<ItemStack> addAll(ItemStackList stacks);
     ...
     * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getMaxCount()}
    ...
    /**
     * @param slot Slot ID to remove from
     * @param strict If <code>true</code>, method fails if amount in list is not strictly {@link Item#getMaxCount()}
     * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getMaxCount()}
     * @return The removed item stack.
     */
     ...
     * @param strict If <code>true</code>, method fails if amount in list is not strictly {@link Item#getMaxCount()} for each stack
     * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getMaxCount()} for each stack
