...
public interface IFluidStackList {
     ...
     * @param strict If <code>true</code>, method fails if amount in list is not strictly {@link sunsetsatellite.catalyst.fluids.api.IFluidInventory#getFluidCapacityForSlot(int)}
     ...
     * @param strict If <code>true</code>, method fails if amount in list is not strictly {@link sunsetsatellite.catalyst.fluids.api.IFluidInventory#getFluidCapacityForSlot(int))} for each stack
