...
public class MenuExporter extends MenuAbstract {

    public MenuExporter(ContainerInventory iinventory, TileEntityExporter tileentityexporter) {
    ...
    private final TileEntityExporter tile;
