...
public class MenuFluidStorageBus extends MenuAbstract {

    public MenuFluidStorageBus(ContainerInventory iinventory, TileEntityFluidStorageBus tile) {
        this.tile = tile;
    ...
    private final TileEntityFluidStorageBus tile;
}
