...
public class MenuAdvInterface extends MenuAbstract {

    public MenuAdvInterface(ContainerInventory iinventory, TileEntityAdvInterface TileEntityAdvInterface) {
    ...
    private final TileEntityAdvInterface tile;
