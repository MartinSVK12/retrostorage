...
import sunsetsatellite.retrostorage.menus.MenuFluidExporter;
import sunsetsatellite.retrostorage.tiles.TileEntityFluidExporter;
import turniplabs.halplibe.helper.EnvironmentHelper;
import turniplabs.halplibe.helper.network.NetworkHandler;

public class ScreenFluidExporter extends ScreenFluidFake {

    public ScreenFluidExporter(ContainerInventory inventoryplayer, TileEntityFluidExporter tileEntityExporter) {
        super(inventoryplayer, new MenuFluidExporter(inventoryplayer, tileEntityExporter));
    ...
    protected void drawGuiContainerForegroundLayer() {
        drawStringNoShadow(fontRenderer,"Fluid Exporter", 56, 6, 0x404040);
