...
public class ScreenFluidStorageBus extends ScreenContainerAbstract implements IExtendedScreenDraw {
    ...
    public ScreenFluidStorageBus(ContainerInventory inventoryplayer, TileEntityFluidStorageBus tile) {
        super(new MenuFluidStorageBus(inventoryplayer, tile));
        ySize = 220;
        this.tile = tile;
    ...
    protected void drawGuiContainerForegroundLayer() {
        drawStringNoShadow(fontRenderer,"Fluid Storage Bus", 45, 6, 0x404040);
        ...
        if(tile.network != null) {
            ...
            if (controller != null) {
                ...
                drawStringCenteredShadow(fontRenderer,NumberUtil.format(tile.getFluidStackAmount()) + "/" + NumberUtil.format(tile.getMaxFluidStackSize()), 90, 112, color);
