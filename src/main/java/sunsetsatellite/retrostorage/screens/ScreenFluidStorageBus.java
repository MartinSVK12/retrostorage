...
public class ScreenFluidStorageBus extends ScreenContainerAbstract implements IExtendedScreenDraw {
    ...
    protected void drawGuiContainerForegroundLayer() {
        font.drawString("Fluid Storage Bus", 45, 6, 0x404040);
        ...
        if(tile.network != null) {
            ...
            if (controller != null) {
                ...
                font.drawCenteredString(NumberUtil.format(tile.getFluidStackAmount()) + "/" + NumberUtil.format(tile.getMaxFluidStackSize()), 90, 112, color);
