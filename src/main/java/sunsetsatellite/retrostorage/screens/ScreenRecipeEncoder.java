...
public class ScreenRecipeEncoder extends ScreenContainerAbstract {
    ...
    protected void drawGuiContainerForegroundLayer() {
        drawStringNoShadow(fontRenderer,"Recipe Encoder", 28, 6, 0x404040);
    ...
    public void init() {
        ...
        recipeNameField = new TextFieldElement(this, fontRenderer, Math.round((float) width / 2 - 81), Math.round((float) height / 2 - 112), 160, 20, "", "Recipe identifier...");
        //}
    ...
    public final TileEntityRecipeEncoder tile;
