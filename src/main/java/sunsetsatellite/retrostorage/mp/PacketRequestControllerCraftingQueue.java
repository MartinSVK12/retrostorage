...
public class PacketRequestControllerCraftingQueue implements NetworkMessage {

    private int x;
    private int y;
    private int z;

    public PacketRequestControllerCraftingQueue() {

    }

    public PacketRequestControllerCraftingQueue(int x, int y, int z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
        ...
        if(EnvironmentHelper.isServerEnvironment()){
            if(context.player != null && context.player.world != null){
                ...
                if(te instanceof TileEntityDigitalController){
                    ...
                    NetworkHandler.sendToPlayer(context.player, new PacketControllerCraftingQueue(x,y,z,c.getRequestQueue()));
                }
            }
        }
    }
