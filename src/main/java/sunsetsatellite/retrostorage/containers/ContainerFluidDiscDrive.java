...
public class ContainerFluidDiscDrive extends Container
{

    public ContainerFluidDiscDrive(IInventory iinventory, TileEntityFluidDiscDrive tileEntitydiscdrive)
    {
    ...
    private TileEntityFluidDiscDrive tile;
