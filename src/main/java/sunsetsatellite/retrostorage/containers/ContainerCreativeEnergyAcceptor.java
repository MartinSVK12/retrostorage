...
public class ContainerCreativeEnergyAcceptor extends Container {

    public TileEntityCreativeEnergyAcceptor tile;

    public ContainerCreativeEnergyAcceptor(IInventory iInventory, TileEntityCreativeEnergyAcceptor tileEntity) {
        tile = tileEntity;
