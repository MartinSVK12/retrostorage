...
public interface NetworkController {
    ...
    @UnmodifiableView
    Set<NetworkFluidStorage> getAttachedFluidStorage();
    ...
    @UnmodifiableView
    List<FluidStack> getAllFluids(Comparator<? super FluidStack> sortingFunction);

    @UnmodifiableView
    Map<NetworkFluidStorage, @UnmodifiableView List<FluidStack>> getFluidMap();
