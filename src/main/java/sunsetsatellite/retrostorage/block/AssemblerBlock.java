...
public class AssemblerBlock extends NetworkDeviceBlock {
    public AssemblerBlock(Identifier identifier, Material material) {
    ...
    public boolean onUse(World world, int x, int y, int z, PlayerEntity player) {
        BlockEntity blockEntity = world.getBlockEntity(x, y, z);
        GuiHelper.openGUI(player,Identifier.of("retrostorage:open_assembler"), (Inventory) blockEntity,new AssemblerScreenHandler(player.inventory, (AssemblerBlockEntity) blockEntity));
        return true;
    }
}
