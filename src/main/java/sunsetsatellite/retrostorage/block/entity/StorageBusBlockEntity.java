...
import sunsetsatellite.retrostorage.util.NetworkItemStorage;

import java.util.ArrayList;
import java.util.List;

public class StorageBusBlockEntity extends NetworkDeviceBlockEntity implements NetworkItemStorage {
    ...
    public void tick() {
        super.tick();
        wrapper.connected = getConnectedBlockEntity(Inventory.class);
    }
