...
public class TileEntityProcessProgrammer extends TileEntityNetworkDevice
    implements IInventory
{
    ...
    public void clearDisc() {
        if(getStackInSlot(1) != null && getStackInSlot(1).getItem() instanceof ItemAdvRecipeDisc){
            ...
            if(disc.hasTagCompound()){
                disc.stackTagCompound.setCompoundTag("disc",new NBTTagCompound());
            }
        }
        tasks.clear();
    }
    ...
    public void saveProcess() {
        if(getStackInSlot(1) != null && getStackInSlot(1).getItem() instanceof ItemAdvRecipeDisc){
            ...
            getStackInSlot(1).stackTagCompound.setCompoundTag("disc",data);
        }
    }
