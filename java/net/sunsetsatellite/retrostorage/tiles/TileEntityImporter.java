                ...
                if(tile != null){
                    ...
                    if(slot == -1){
                        for (int i = 0; i < inv.getSizeInventory(); i++) {
                            ...
                            if(stack != null && ((getInventorySlotContainItem(stack.itemID,stack.getItemDamage()) != -1 && isWhitelist) || (getInventorySlotContainItem(stack.itemID,stack.getItemDamage()) == -1 && !isWhitelist))){
