...
public class InventoryPortable implements IInventory {
	...
	public int storeItemStack(ItemStack stack) {
		for(int i2 = 0; i2 < this.inventoryContents.length; ++i2) {
			if(this.inventoryContents[i2] != null && this.inventoryContents[i2].itemID == stack.itemID && (this.inventoryContents[i2].stackTagCompound).equals(stack.stackTagCompound) && this.inventoryContents[i2].isStackable() && this.inventoryContents[i2].stackSize < this.inventoryContents[i2].getMaxStackSize() && this.inventoryContents[i2].stackSize < this.getInventoryStackLimit() && (!this.inventoryContents[i2].getHasSubtypes() || this.inventoryContents[i2].getItemDamage() == stack.getItemDamage())) {
				return i2;
			}
		}
