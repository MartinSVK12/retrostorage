...
import net.sunsetsatellite.retrostorage.util.ProcessTask;
...
public class GuiTaskSlot extends GuiSlot {
    ...
    protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator) {
        ...
        if(task instanceof RecipeTask){
            ...
            String name = trans.translateKey(((RecipeTask)task).recipe.getRecipeOutput().getItem().getItemNameIS(((RecipeTask)task).recipe.getRecipeOutput()) + ".name");
            ...
            StringTranslate trans = StringTranslate.getInstance();
            String name = trans.translateKey(((ProcessTask)task).output.getItem().getItemNameIS(((ProcessTask)task).output) + ".name");
