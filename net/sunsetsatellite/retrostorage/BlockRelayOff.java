...
public class BlockRelayOff extends Block {
	
	public static int sprites[];

	public BlockRelayOff(int i) {
	 ...
	 public static void loadSprites()
    {
		...
		sprites = new int[4];
        sprites[0] = mod_RetroStorage.relayOffTex; //bottom
        sprites[1] = mod_RetroStorage.relayOffTex; //front
        sprites[2] = mod_RetroStorage.relayOffTex; //side
        sprites[3] = mod_RetroStorage.relayOffTex; //top 1
