...
public class CraftingManager
{
    ...
    void addRecipe(ItemStack itemstack, Object aobj[])
    {
        ...
        /*if (itemstack.getItem() == Item.stick || itemstack.itemID == Block.pressurePlatePlanks.blockID) {
        	System.out.println(j);
        	System.out.println(k);
        	ArrayList arraylist = new ArrayList(Arrays.asList(aitemstack));
    ...
    public ItemStack findMatchingRecipeFromArray(ArrayList<ItemStack> list) {
    	 for(int i = 0; i < recipes.size(); i++)
         {
             ...
             //System.out.println(irecipe.getRecipeItems().toString());
             
             /*if(irecipe.getRecipeOutput().itemID == Block.cloth.blockID) {
            	 System.out.println(i+": "+irecipe.getRecipeItems().toString());
            	 System.out.println(irecipe.matchesArray(list));
            	 //return irecipe.getRecipeOutput();
             }*/
             /*if(irecipe.getRecipeOutput().itemID == Block.pressurePlatePlanks.blockID) {
            	 System.out.println(i+": "+irecipe.getRecipeItems().toString());
            	 System.out.println(irecipe.matchesArray(list));
            	 //return irecipe.getRecipeOutput();
             }
             if(irecipe.getRecipeOutput().itemID == Item.stick.shiftedIndex) {
            	 System.out.println(i+": "+irecipe.getRecipeItems().toString());
            	 System.out.println(irecipe.matchesArray(list));
            	 //return irecipe.getRecipeOutput();
             }*/
             ...
             if (irecipe instanceof ShapelessRecipes) {
            	 ArrayList<ItemStack> modifiedList = list;
            	 for (int j = 0;j<modifiedList.size();j++) {
            		 if(modifiedList.get(j) == null) {
            			 modifiedList.remove(j);
            		 }
            	 }
            	 if(irecipe.getRecipeItems().equals(list))
                 {
                     return irecipe.getRecipeOutput();
                 }
