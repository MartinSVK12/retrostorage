...
public final class ItemStack
{
    ...
    {
        stackSize -= i;
        return new ItemStack(itemID, i, itemDamage, itemData);
    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setCompoundTag("Data", (NBTTagCompound)itemData);
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        itemData = nbttagcompound.getCompoundTag("Data");
    }
    ...
    private boolean isItemStackEqual(ItemStack itemstack)
    {
        ...
        if(!itemData.equals(itemstack.itemData)) {
        	return false;
        }
